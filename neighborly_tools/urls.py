...
urlpatterns = [
    ...
    path(
        "borrow/<int:signup_id>/",
        ToolSignUpDetailView.as_view(),
        name="tool-borrow-detail",
    ),
    path(
        "get_tools_exclude_user/", get_tools_exclude_user, name="get_tools_exclude_user"
    ),
