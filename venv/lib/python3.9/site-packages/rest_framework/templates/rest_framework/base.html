...
<html>
  ...
  <body class="{% block bodyclass %}{% endblock %}">
    ...
    <div class="wrapper">
      {% block header %}
        <div class="header header-static-top {% block bootstrap_navbar_variant %}header-inverse{% endblock %}"
             role="navigation" aria-label="{% trans "header" %}">
          <div class="container">
            <span>
              {% block branding %}
                <a class='header-brand' rel="nofollow" href='https://www.django-rest-framework.org/'>
